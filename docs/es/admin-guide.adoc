...
Este script genera un archivo `.env` con secretos aleatorios. Revise y ajuste la configuración según sea necesario antes de iniciar.

Instale el plugin Docker de Loki (necesario para el envío de registros):
