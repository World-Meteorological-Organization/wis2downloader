...
Ce script génère un fichier `.env` avec des secrets aléatoires. Vérifiez et ajustez les paramètres si nécessaire avant de démarrer.

Installez le plugin Docker Loki (requis pour l'envoi des journaux) :
