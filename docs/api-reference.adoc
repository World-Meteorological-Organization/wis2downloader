...
wis2_downloads_total{cache="example.cache.com",media_type="application/bufr"} 42.0

# HELP wis2_notifications_total Total notifications processed.
# TYPE wis2_notifications_total counter
wis2_notifications_total{status="success"} 42.0
wis2_notifications_total{status="skipped"} 5.0
----
