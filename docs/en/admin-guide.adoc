...
This generates `.env` with randomised secrets. Review and adjust settings as needed before starting.

Install the Loki Docker logging plugin (required for log shipping):
