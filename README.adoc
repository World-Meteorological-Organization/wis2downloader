...
Download the https://github.com/World-Meteorological-Organization/wis2downloader/releases/latest[latest release] tarball and extract it, then enter the extracted directory.
...
# Install Loki Docker logging plugin (required for log shipping)
...
TIP: To follow the latest development version instead, clone the repository with `git clone https://github.com/World-Meteorological-Organization/wis2downloader.git`.
